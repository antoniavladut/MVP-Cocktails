...
INSERT INTO cocktails (title, method, glass, ice, garnish, ingredients, instructions, imageUrl, favourite)  
    VALUES
        ...
        ('Pornstar Martini', 'Shake', 'Coupe', 'Cubed', 'Passion fruit half', '6cl Vanilla Vodka, 1.5cl Passoã Liqueur, 1.5cl Sugar Syrup, 1.5cl Lime Juice, 6cl Prosecco', '1. 1. Chill glass with ice, and add another handful to the shaker 2.Scoop out the inside of 3 passion fruit halves into your shaker 3. Add all ingredients (except the prosecco) to shaker and shake hard 3. Empty ice from glasses and strain drink into chilled glass 4. Add the remaining passion fruit half garnish 5. Pour prosecco in shot glass 6. Serve!', 'https://i.pinimg.com/564x/ec/de/3d/ecde3d11668520fc240c294963d8f290.jpg', false ),
